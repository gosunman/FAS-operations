...
> Operations는 Doctrine(원칙/정체성)을 코드로 실현하는 계층.
> 생성일: 2026-03-18
...
EIDOS SCIENCE ([MASKED_PII]) 운영 자동화.
...
- `scripts/setup/com.fas.captain.plist` — `/Users/[MASKED_USER]/FAS-operations/...`
...
# 프로젝트 경로
PROJECT_DIR=/Users/[MASKED_USER]/FAS-operations
