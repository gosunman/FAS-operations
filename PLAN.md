...
### Stage 1: 검증 단계 (현재 → 안정화까지)

최소 비용으로 시스템이 제대로 동작하는지 확인.

| 에이전트 | 플랜 | 월 비용 | 비고 |
|---------|------|---------|------|
| 캡틴 Claude Code | Max (계정 A, 기존) | $100 | 이미 사용 중 |
| 캡틴 Gemini CLI | 무료 Tier | $0 | 이미 사용 중 |
| 헌터 Claude Code | **무료 or Pro** (계정 B) | $0~$20 | 세팅 검증용 |
| 헌터 ChatGPT | **무료 or Plus** | $0~$20 | 세팅 검증용 |
| **월 합계** | | **$100~$140** | |

**이 단계의 목표:**
- 헌터 ↔ 캡틴 Task API 통신이 안정적으로 동작하는지 확인
- Playwright 기반 web_crawl, browser_task가 헌터에서 정상 실행되는지 확인
- 계정 격리(SA-001)가 올바르게 적용되는지 확인
- deep_research, notebooklm_verify는 구글 무료 계정으로도 기본 동작 가능

**승격 조건:** Task API 통신 성공률 95%+, 연속 3일 무장애 운영

### Stage 2: 운영 단계

기본 플랜으로 실제 업무를 돌리며 용량·속도 한계를 체감.

| 에이전트 | 플랜 | 월 비용 | 비고 |
|---------|------|---------|------|
| 캡틴 Claude Code | Max (계정 A) | $100 | 유지 |
| 캡틴 Gemini CLI | 무료 Tier | $0 | 유지 |
| 헌터 Claude Code | **Pro** (계정 B) | **$20** | 코딩/분석 태스크 |
...
|---------|------|---------|------|
| 캡틴 Claude Code | Max (계정 A) | $100 | 유지 |
| 캡틴 Gemini CLI | Pro 또는 유지 | $0~$20 | 필요 시 |
